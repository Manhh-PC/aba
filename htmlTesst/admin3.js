$(document).ready(function () {
  ...
  function displayUsers(users) {
    ...
    if (users.length === 0) {
      // Hiển thị thông báo khi không có user
      $userContainer.html(`
          <div class="no-users">
      ...
      // Hiển thị danh sách user với STT
  ...
  function attachEventListeners() {
    ...
    $(".edit-user")
      ...
      .on("click", function (e) {
        ...
        // Lấy thông tin hiện tại (chỉ lấy tên từ .user-name)
        ...
        // Thay thế nội dung bằng form chỉnh sửa (không có STT)
        $userBox.html(`
